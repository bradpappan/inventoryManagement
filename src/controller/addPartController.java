...
/**
 * Class controller that runs the add part screen.
 */
public class addPartController implements Initializable {
    ...
    /**
     * When save button is pressed this saves the part inputted for both outsourced or in house radio button selected.
     *
    ...
    public void saveHandler(ActionEvent event) throws IOException {
        try {
            ...
            int stock = tryParseInventory(partInventory.getText());
     ...
     *
     * @param event exits the screen
     * @throws IOException returns back to the main screen
     */
     ...
     *
     * @param event called to return to main menu
     * @throws IOException returns back to main menu
     */
